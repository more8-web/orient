...
class EditContentResponseBody
{
    ...
    /**
     * @SWG\Property(property=EditContentResponseBody::CONTENT_ID, type="integer")
     */
    private $id;

    /**
     * @SWG\Property(property=EditContentResponseBody::CONTENT_ALIAS, type="string")
     */
    private $contentAlias;

    /**
     * @SWG\Property(property=EditContentResponseBody::CONTENT_DESCRIPTION, type="string")
     */
    private $contentDescription;

    /**
     * @SWG\Property(property=EditContentResponseBody::CONTENT_VALUE, type="string")
     */
