...
class EditHtmlTagResponseBody
{
    ...
    /**
     * @SWG\Property(property=EditHtmlTagResponseBody::HTML_TAG_ID, type="integer")
     */
    private $id;

    /**
     * @SWG\Property(property=EditHtmlTagResponseBody::HTML_TAG_VALUE, type="string")
     */
    private $htmlTagValue;

    /**
     * EditHtmlTagResponseBody constructor.
