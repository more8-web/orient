 ...
 */
class CreateNewKeywordResponseBody
{
    const
        KEYWORD_ID = "id",
    ...
    /**
     * @SWG\Property(property=CreateNewKeywordResponseBody::KEYWORD_ID, type="integer")
     */
    private $id;

    /**
     * @SWG\Property(property=CreateNewKeywordResponseBody::KEYWORD_VALUE, type="string")
     */
