 ...
 */
class CreateContentCategoryRequestBody
{
    const
    ...
    /**
     * @SWG\Property(property=CreateContentCategoryRequestBody::CONTENT_CATEGORY_PARENT_ID, type="integer")
     */
    private $contentCategoryParentId = null;

    /**
     * @SWG\Property(property=CreateContentCategoryRequestBody::CONTENT_CATEGORY_ALIAS, type="string")
     * @Assert\NotBlank()
     */
    private $contentCategoryAlias;

    /**
     * CreateContentCategoryRequestBody constructor.
     * @param array $data
     */
