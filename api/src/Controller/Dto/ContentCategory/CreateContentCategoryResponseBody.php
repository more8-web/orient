 ...
 */
class CreateContentCategoryResponseBody implements ResponseBodyInterface
{
    const
    ...
    /**
     * @SWG\Property(property=CreateContentCategoryResponseBody::CONTENT_CATEGORY_ID, type="integer")
     * @Assert\NotBlank()
     */
    private $contentCategoryId;

    /**
     * @SWG\Property(property=CreateContentCategoryResponseBody::CONTENT_CATEGORY_PARENT_ID, type="integer")
     */
    private $contentCategoryParentId = null;

    /**
     * @SWG\Property(property=CreateContentCategoryResponseBody::CONTENT_CATEGORY_ALIAS, type="string")
     * @Assert\NotBlank()
     */
